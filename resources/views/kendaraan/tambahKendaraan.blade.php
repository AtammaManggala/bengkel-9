                            ...
                            <div class="card card-primary card-outline mb-4">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control"  name="kendaraan"/><br>

                                        <label for="" class="form-label">Tahun Kendaraan</label>
                                        <input type="text" class="form-control"  name="thn_kendaraan"/><br>
                                        
                                        <label for="" class="form-label">Nomor Mesin</label>
                                        <input type="text" class="form-control"  name="no_mesin_kendaraan"/><br>

                                        <label for="" class="form-label">Nomor Rangka</label>
                                        <input type="text" class="form-control"  name="no_rangka_kendaraan"/><br>

                                        <label for="" class="form-label">Kapasitas Mesin</label>
                                        <input type="text" class="form-control"  name="kapasitas_mesin_kendaraan"/><br>

                                        <label for="" class="form-label">Transmisi</label>
                                        <input type="text" class="form-control"  name="transmisi_kendaraan"/><br>
